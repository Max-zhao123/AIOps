...
```bash
# 克隆项目
git clone https://github.com/aiops/aiops.git
cd aiops
...
aiops 是一个 **开源项目**，欢迎所有开发者、运维工程师和 AI 爱好者加入！  
...
aiops 采用 **Apache License 2.0**，可自由用于商业和个人项目。  
